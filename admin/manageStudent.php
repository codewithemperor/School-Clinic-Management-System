    ...
    <div class="main">
        <div class="sidebar background ">
            ...
            <ul>
                        ...
                        <li>
                            <a href="manageStudent.php?logout">
                                <span class="icon">
        ...
        <div class="main-body">
            ...
            <div class="container-fluid p-5">
                <div class="row">
                    <div class="col-8">
                        <p class="h2 text-success fw-bolder">Manage Student</p>
                    ...
                    <table class="table table-hover" id="example">
                        <thead class="table-dark">
                            <tr class="align-middle">
                                ...
                                <th class="py-3">HEALTH CARE NO</th>
                                <th class="py-3">MATRIC NO</th>
                                <th class="py-3">PHONE NUMBER</th>
                                <th class="py-3">PRORGAMME</th>
                        ...
                        <tbody class="">
                            ...
                            <!-- <tr class="align-middle">
                                ...
                                <td class="d-flex">
                                    ...
                                    <a class="col p-1 btn bg-primary me-1">
                                        <i class="ri-eye-fill"></i>
                                    </a>
